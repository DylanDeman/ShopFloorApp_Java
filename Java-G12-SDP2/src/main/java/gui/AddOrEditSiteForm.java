...
public class AddOrEditSiteForm extends AddOrEditAbstract
{
    ...
    protected void initializeFields()
    {
        ...
        employeeBox.setPromptText("Selecteer verantwoordelijke");
    ...
    private Node createComboBoxSection()
    {
        ...
        String labelString = isNew ? "Verantwoordelijke" : "Verantwoordelijke en status";
    ...
    {
        return isNew ? "Site toevoegen" : "Site aanpassen";
    }
