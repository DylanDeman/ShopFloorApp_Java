...
public class AddReportForm extends AddOrEditAbstract
{
    ...
    protected void initializeFields()
    {
        ...
        technicianComboBox.getItems()
                .addAll(userController.getAllTechniekers().stream().map(user -> user.firstName()).collect(Collectors.toList()));
    ...
    protected void save()
    {
        ...
        try
        {
            ...
            UserDTO technician = selectedTechnician != null ? userController.getUserById(selectedTechnician.id()) : null;

            reportController.createReport(siteWoMachines, 
                    maintenance,
                    technician, 
