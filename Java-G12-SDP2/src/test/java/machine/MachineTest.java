...
class MachineTest {
    ...
    void setUp() {
        ...
        machine = new Machine.Builder()
                .buildSite(mockSite)
                .buildTechnician(mockTechnician)
                .buildCode("MCH-001")
                .buildLocation("Zone A")
                .buildProductInfo("Widget Maker")
    ...
    void builder_buildsMachineWithAllFields() {
        ...
        Machine constructed = new Machine.Builder()
                .buildSite(mockSite)
                .buildTechnician(mockTechnician)
                .buildCode("MCH-123")
                .buildLocation("Room B")
                .buildProductInfo("Info")
                .buildMachineStatus(MachineStatus.DRAAIT)
                .buildProductionStatus(ProductionStatus.FALEND)
                .buildFutureMaintenance(futureMaintenance)
                .build();
    ...
    void builder_missingRequiredFields_throwsException() {
        ...
        InformationRequiredExceptionMachine thrown = assertThrows(
            InformationRequiredExceptionMachine.class,
            builder::build
        );
