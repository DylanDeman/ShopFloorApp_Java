...
class MaintenanceControllerTest {
    ...
    @BeforeEach
    void setUp() throws InformationRequiredExceptionUser, InformationRequiredExceptionMachine, InformationRequiredExceptionSite {
    ...
    private void setupTestUsers() throws InformationRequiredExceptionUser {
        // Test users aanmaken:
        technician = new User.Builder()
                .buildFirstName("John")
                .buildLastName("Doe")
                .buildEmail("john.doe@example.com")
                .buildPhoneNumber("123456789")
                .buildPassword("securePassword")
                .buildBirthdate(LocalDate.of(1985, 5, 15))
                .buildRole(Role.TECHNIEKER)
                .buildStatus(Status.ACTIEF)
                .buildAddress("Main Street", 42, 1000, "Brussels")
                .build();
        technician.setId(1);
        
        siteManager = new User.Builder()
                .buildFirstName("Jane")
                .buildLastName("Smith")
                .buildEmail("jane.smith@example.com")
                .buildPhoneNumber("987654321")
                .buildPassword("securePassword")
                .buildBirthdate(LocalDate.of(1980, 8, 20))
                .buildRole(Role.VERANTWOORDELIJKE)
                .buildStatus(Status.ACTIEF)
                .buildAddress("Manager Street", 10, 1000, "Brussels")
                .build();
        siteManager.setId(2);
    }
    ...
    private void setupTestSite() throws InformationRequiredExceptionSite {
        ...
        site = new Site.Builder()
                .buildSiteName("Production Site Alpha")
                .buildAddress("Factory Road", 123, 1050, "Brussels")
                .buildVerantwoordelijke(siteManager)
                .buildStatus(Status.ACTIEF)
    ...
    private void setupTestMachine() throws InformationRequiredExceptionMachine {
        ...
        machine = new Machine.Builder()
                ...
                .buildCode("MACH-001")
                .buildLocation("Production Floor A")
                .buildProductInfo("Product X-100")
                .buildMachineStatus(MachineStatus.DRAAIT)
                .buildProductionStatus(ProductionStatus.GEZOND)
                .buildFutureMaintenance(LocalDate.now().plusMonths(1))
                .build();
        machine.setId(1);
    ...
    private Maintenance createTestMaintenance(int id, LocalDate executionDate, LocalDateTime startDate, 
                                              LocalDateTime endDate, String reason, String comments,
    ...
    private void assertMaintenanceDTOEquals(MaintenanceDTO dto, int id, LocalDate executionDate, 
                                           ...
                                           String reason, String comments, MaintenanceStatus status,
                                           int technicianId, String technicianFirstName,
                                           int machineId) {
    ...
    void getMaintenances_ShouldReturnAllMaintenancesAsDTO() {
        Maintenance maintenance1 = createTestMaintenance(
                1, defaultExecutionDate, defaultStartDate, defaultEndDate, 
                "Regular check", "All good", MaintenanceStatus.VOLTOOID);
        
        Maintenance maintenance2 = createTestMaintenance(
                2, defaultExecutionDate.plusDays(1), defaultStartDate.plusDays(1), 
                defaultEndDate.plusDays(1), "Repair", "Fixed issue", MaintenanceStatus.INGEPLAND);
        ...
        assertMaintenanceDTOEquals(result.get(1), 2, defaultExecutionDate.plusDays(1), 
                defaultStartDate.plusDays(1), defaultEndDate.plusDays(1),
                "Repair", "Fixed issue", MaintenanceStatus.INGEPLAND, 1, "John", 1);
    ...
    void getMaintenance_ShouldReturnMaintenanceById() {
        int maintenanceId = 1;
        Maintenance expectedMaintenance = createTestMaintenance(
                maintenanceId, defaultExecutionDate, defaultStartDate, defaultEndDate, 
                "Regular check", "All good", MaintenanceStatus.VOLTOOID);
    ...
    void getMaintenanceDTO_ShouldReturnMaintenanceDTOById() {
        ...
        assertNotNull(result);
        assertMaintenanceDTOEquals(result, maintenanceId, defaultExecutionDate, 
                defaultStartDate, defaultEndDate, "Regular check", "All good", 
                MaintenanceStatus.VOLTOOID, 1, "John", 1);
