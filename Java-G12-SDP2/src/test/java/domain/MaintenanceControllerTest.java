...
class MaintenanceControllerTest {
    ...
    void testUpdateMaintenance_Success_StatusVoltooid_UpdatesMachine() throws InformationRequiredExceptionMaintenance {
        ...
        MaintenanceDTO result = maintenanceController.updateMaintenance(maintenanceId, executionDate, startDate, endDate,
                technicianId, "reason", "comments", MaintenanceStatus.VOLTOOID, machineId);
    ...
    @Test
    void testUpdateMaintenance_Success_StatusNotVoltooid_DoesNotUpdateMachine() throws InformationRequiredExceptionMaintenance {
        int maintenanceId = 1;
        LocalDate executionDate = LocalDate.of(2025, 5, 19);
        LocalDateTime startDate = LocalDateTime.now().minusHours(2);
        LocalDateTime endDate = LocalDateTime.now();
        ...
        MaintenanceDTO result = maintenanceController.updateMaintenance(maintenanceId, executionDate, startDate, endDate,
                technicianId, "reason", "comments", MaintenanceStatus.IN_UITVOERING, machineId);
